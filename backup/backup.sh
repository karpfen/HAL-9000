#!/bin/bash
# Backs up home-assistant, mealie, paperless and/or nextcloud to $BACKUP_ROOT
# (default: /mnt/terramaster/backups) as incremental, hardlinked snapshots.
#
# Usage: backup.sh [home-assistant|mealie|paperless|nextcloud|all]
set -euo pipefail
...
all)
	...
	;;
*)
	echo "Usage: $0 [home-assistant|mealie|paperless|nextcloud|all]" >&2
	exit 1
	;;
esac
